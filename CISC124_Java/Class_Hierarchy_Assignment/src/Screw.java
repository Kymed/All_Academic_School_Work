...
public abstract class Screw extends ThreadedSizedFastener implements Serializable {
	...
	public Screw(double unitPrice, int numPerUnit, Threads thread, double length, Enum<?> material, Enum<?> finish, Enum<ScrewDesigns.ScrewHeads> head, Enum<ScrewDesigns.ScrewDrive> drive)
